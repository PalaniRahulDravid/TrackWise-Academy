          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {FUNNY_GAMES.map((game) => (
              <button
                ...
                className="bg-gray-900/50 border border-gray-700 rounded-2xl text-center shadow hover:shadow-xl hover:bg-orange-900/40 transition p-7 flex flex-col items-center justify-center cursor-pointer"
              >
                <img
                  src={game.img}
                  alt={game.name}
