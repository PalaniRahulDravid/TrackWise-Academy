export default function FeatureCard({ title, desc, href, gradient, icon }) {
  return (
    <a 
      href={href} 
      className="group block bg-gray-900 rounded-xl sm:rounded-2xl overflow-hidden hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl"
    >
      {/* Gradient section */}
