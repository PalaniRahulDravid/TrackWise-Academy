...
//     try {
//       const { data } = await axios.post(`${API_BASE_URL}/dsa/problems/${id}/run`, {
//         code,
//         language: "python"
//       });
...
//   // Submit solution (all test cases including hidden)
...
//     setShowResults(false);
//     try {
//       const { data } = await axios.post(`${API_BASE_URL}/dsa/problems/${id}/submit`, {
//         code,
//         language: "python",
//         userId: user._id
//       });
...
//                 {/* Examples - FIXED BEAUTIFUL UI LIKE LEETCODE */}
...
//                 <button
//                   onClick={() => setCode(problem.codeTemplates?.python || "")}
